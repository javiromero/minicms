...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Home.precios'
        db.add_column('paginas_home', 'precios', self.gf('django.db.models.fields.TextField')(default='A\xc3\xb1adir precios'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Home.precios'
        db.delete_column('paginas_home', 'precios')

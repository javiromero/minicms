...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('paginas_notificationemail', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('configuracion', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['paginas.Configuracion'])),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
        ))
        db.send_create_signal('paginas', ['NotificationEmail'])


    def backwards(self, orm):
        
        # Deleting model 'NotificationEmail'
        db.delete_table('paginas_notificationemail')
